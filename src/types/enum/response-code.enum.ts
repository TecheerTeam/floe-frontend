export enum ResponseCode {
    ...
    // notification
    NOTIFICATION_CONNECT_SUCCESS = "N001",
    NOTIFICATION_LIST_GET_SUCCESS = "N002",
    NOTIFICATION_READ_SUCCESS = "N003",
    NOTIFICATION_ALL_READ_SUCCESS = "N004",
    NOTIFICATION_DELETE_SUCCESS = "N005",
    NOTIFICATION_ALL_DELETE_SUCCESS = "N006",
    NOTIFICATION_UNREAD_COUNT_GET_SUCCESS = "N007",
